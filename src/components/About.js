...
export default function About(props) {
  return (
    // Fixed: Corrected "conatiner" to "container" to add side padding
    <div className='container my-5 text-center'>
        <div className='row justify-content-center'>
            <div className='col-lg-8'>
                ...
                {/* Changed text-start to text-md-start for better mobile centering */}
                <p className='lead mt-4 text-md-start'>
